        ...
        <AnimatePresence>
          ...
          <FadeUp key="description-1" duration={0.6} delay={0.2}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              As a final-year Bachelor of Information Technology student at the University of Moratuwa and a current trainee software engineer,
              I bring a passion for software development.
              I am eager to contribute to your organization's goals with my practical experience and strong communication skills.
            </p>
          </FadeUp>
          <FadeUp key="description-2" duration={0.6} delay={0.4}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              I turn vision into reality with code. Whether I'm working on a website or any digital product,
