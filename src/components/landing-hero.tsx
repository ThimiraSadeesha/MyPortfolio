          ...
          <AnimatePresence>
            <FadeUp key="title-main" duration={0.6}>
              ...
              <span className="text-xl font-semibold text-zinc-900 dark:text-zinc-100 md:text-3xl">
                Fullstack Software Engineer <span className="text-accent"> Mobile & Web</span>
              </span>
            </FadeUp>
            <FadeUp key="description" duration={0.6} delay={0.2}>
              <div className="mt-8 max-w-3xl text-base font-semibold text-zinc-900 dark:text-zinc-200 sm:text-base md:text-2xl">
                ...
                I&apos;m
                <span className="text-accent"> Thimira Sadeesha</span> , I transform ideas into functional and beautiful digital experiences through code and design.
              </div>
            </FadeUp>
          </AnimatePresence>
        </div>
